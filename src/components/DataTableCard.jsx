...
export default function DataTableCard({
  ...
  // Filter rows based on search term across all text columns
  ...
  // Sort rows if sortColumnKey is set
            ...
            <thead>
              <tr>
                {columns.map((col) => (
                  ...
                  >
                    {col.label}{' '}
                    {col.sortable !== false && <ArrowUpDown size={10} style={{ opacity: sortColumnKey === col.key ? 1 : 0.4 }} />}
                  </th>
                ))}
              </tr>
            </thead>
